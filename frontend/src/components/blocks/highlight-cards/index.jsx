...
export default function HighlightCards() {
  const projects = [
  {
    ...
    description: "Sistema completo de gestão clínica desenvolvido especialmente para psicólogos e terapeutas, incluindo agendamento online, prontuário eletrônico seguro, teleconsulta integrada e gestão financeira. Aumente sua produtividade em 40% com nossa solução especializada.",
  ...
  },
  {
    ...
    description: "Plataforma de gestão jurídica completa para escritórios de advocacia, com controle de processos automatizado, prazos processuais inteligentes, integração com tribunais e relatórios personalizados. Reduza em 60% o tempo gasto com tarefas administrativas.",
    client: "Silva & Associados",
    role: "Product Owner & Especialista em Direito Digital",
    technologies: ["Java", "Processo Judicial Eletrônico", "BI", "Prazos Processuais", "Cloud Computing"],
    year: "2022",
    link: "#",
  },
    {
          ...
          {projects.map((project, index) => (
            <div
              ...
              <div className="grid md:grid-cols-3">
                {/* Project Image */}
                <div
                  className="relative aspect-[16/9] w-full overflow-hidden md:aspect-auto md:h-full">
                ...
                <div className="p-6 md:col-span-2 md:p-8">
                  ...
                  <div
                    className="text-muted-foreground mb-4 flex flex-col flex-wrap gap-x-4 text-sm md:flex-row">
