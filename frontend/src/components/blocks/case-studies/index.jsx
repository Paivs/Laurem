              ...
              <AccordionItem
                ...
                <AccordionTrigger className="px-6 py-5 hover:no-underline">
                  <div className="flex flex-1 items-center gap-4">
                    <div
                      className="relative hidden h-16 w-16 overflow-hidden rounded-md border sm:block">
                        ...
                        <ul className="space-y-2">
                          {study.results.map((result, index) => (
                            <li key={index} className="flex items-start gap-2 text-sm">
                              <span
                                className="bg-primary/10 text-primary flex h-5 w-5 flex-shrink-0 items-center justify-center rounded-full text-xs font-medium">
                                {index + 1}
                              </span>
                              <span>{result}</span>
                            </li>
