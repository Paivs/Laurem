...
const features = [
  ...
  },
  {
    ...
    description:
      "Recursos de segurança nativos para proteger seus dados e usuários.",
  },
  {
    icon: ZapIcon,
    title: "Integração Fácil",
    description:
      "Simples de integrar com suas ferramentas e fluxos de trabalho existentes.",
  },
  {
    icon: BarChartIcon,
    title: "Análises",
    description:
      "Métricas detalhadas para acompanhar seu progresso e resultados.",
  },
];
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
        {features.map((feature, idx) => (
          <motion.div
            ...
            initial={{ scale: 0 }}
            whileInView={{ scale: 1 }}
            transition={{ duration: idx / 3, delay: idx / 3 }}
            viewport={{ once: true }}
          >
            <Card className="p-0">
