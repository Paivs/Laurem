      ...
      <div className="mx-auto max-w-3xl">
        <div className="mb-8 text-center">
          ...
          <p className="text-muted-foreground mt-2">
            Tornamos suas ideias em soluções para o mundo real. Conheça nossos
          ...
          >
            <AccordionTrigger className="py-6 text-left hover:no-underline">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-lg font-semibold">Colaborativo</h3>
                  <p className="text-muted-foreground text-sm">
                    Vamos democratizar o acesso a sua solução. Desenvolvemos o
                    software de forma gratuíta!
                  </p>
                </div>
              </div>
            </AccordionTrigger>
            <AccordionContent className="pt-2 pb-6">
              <div className="space-y-6 text-sm">
                ...
                <div className="bg-muted/50 rounded-lg p-4">
                  <p className="text-sm">
                    <strong>Note:</strong> Projetos de software livre são
                    sujeitos a licenças especiais. O processo de elaboração das
                    soluções pode variar. Entre em contato para se iterar.
                  </p>
                </div>
              </div>
            </AccordionContent>
          ...
          >
            <AccordionTrigger className="py-6 text-left hover:no-underline">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-lg font-semibold">Privativo e permissivo</h3>
                  <p className="text-muted-foreground text-sm">
                    Você recebe o que pede no tempo acordado
                  </p>
                </div>
              </div>
            </AccordionTrigger>
                ...
                <div className="grid gap-6 md:grid-cols-3">
                  <div className="text-center">
                    ...
                    <p className="text-muted-foreground">
                      Definimos as caracteristicas gerais da aplicação
                    </p>
                  </div>
                  <div className="text-center">
                    ...
                    <h4 className="mb-2 font-medium">Desenvolvimento</h4>
                    <p className="text-muted-foreground">
                      O software é contruído com seu feedback em tempo real
                    </p>
                  </div>
                  <div className="text-center">
                    ...
                    <h4 className="mb-2 font-medium">Entrega</h4>
                    <p className="text-muted-foreground">
                      Você recebe o código fonte e, caso queira, temos modelos de continuidade de projeto
                    </p>
                  </div>
                </div>
          ...
          >
            <AccordionTrigger className="py-6 text-left hover:no-underline">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-lg font-semibold">Refatoração</h3>
                  <p className="text-muted-foreground text-sm">
