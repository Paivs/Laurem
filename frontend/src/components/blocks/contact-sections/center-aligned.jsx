...
export default function CenterAligned() {
  return (
    <div
      ...
      <div
        className="mt-12 grid items-center gap-4 sm:grid-cols-2 lg:grid-cols-3 lg:gap-8">
        <Link
          href={"#"}
          ...
          <div className="mt-5">
            ...
            <p
              className="text-primary mt-5 inline-flex items-center gap-x-1 font-medium">
              Contact support
              <svg
